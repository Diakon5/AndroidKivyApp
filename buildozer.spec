...
requirements = python3, kivy, trio, attrs, outcome, sniffio, sortedcontainers, exceptiongroup, kivy_reloader, toml, anysqlite, anyio
...
android.gradle_dependencies = 
    cz.adaptech.tesseract4android:tesseract4android-openmp:4.7.0
